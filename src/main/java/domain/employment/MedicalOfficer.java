...
public class MedicalOfficer extends Employee {
    ...
    public MedicalOfficer(Employee employee) {
        super(employee.getPersonalnumber(), employee.getFirstName(), employee.getLastName(), employee.getBirthdate(),
            employee.getWard(), employee.getSalary());
    }
}
